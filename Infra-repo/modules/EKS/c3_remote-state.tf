...
data "terraform_remote_state" "vpc" {
  ...
  config = {
    bucket = "tfstate-dev-root-ap-south-1-dv7swa-main-bkt" # Name of the remote S3 bucket where the VPC state is stored . Here update bucket detail from "00-S3_bucket_remote_backend"
