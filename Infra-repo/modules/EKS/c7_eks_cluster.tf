...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    # subnet_ids = data.terraform_remote_state.vpc.outputs.private_subnet_ids ## for this demo only using Public subnet, so commented. In prod we ned to use Private subnets for hosting workloads
